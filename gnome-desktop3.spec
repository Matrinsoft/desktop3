...
* Wed Mar 25 2026 Jan Grulich <jgrulich@redhat.com> - 44.5-5
- Add configuration for release-monitoring

* Mon Mar 02 2026 Jan Grulich <jgrulich@redhat.com> - 44.5-4
- Packit: drop upstream_project_url and rely on release-monitoring only

* Wed Feb 25 2026 Jan Grulich <jgrulich@redhat.com> - 44.5-3
- Packit: drop fast_forward_merge_into as current stable branches diverge

* Tue Feb 24 2026 Jan Grulich <jgrulich@redhat.com> - 44.5-2
- Onboard to Packit for stable Fedora branches

* Mon Feb 09 2026 Jan Grulich <jgrulich@redhat.com> - 44.5-1
- Update to 44.5

* Fri Jan 16 2026 Fedora Release Engineering <releng@fedoraproject.org> - 44.4-3
- Rebuilt for https://fedoraproject.org/wiki/Fedora_44_Mass_Rebuild

* Wed Dec 17 2025 Adrian Vovk <adrianvovk@gmail.com> - 44.4-2
- Drop gnome-mimeapps.list handling
